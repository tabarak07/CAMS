...
<head>
  ...
  <title>University Addmission Management System!! Forgot Password
  </title>
        ...
        <ul class="nav navbar-nav flex-row">
          ...
          <li class="nav-item">
            <a class="navbar-brand" href="../index.php">
              ...
              <h3 class="brand-text">University Admission Management System  | Recover Password</h3>
            </a>
          </li>
        ...
        <section class="flexbox-container">
          <div class="col-12 d-flex align-items-center justify-content-center">
            <div class="col-md-4 col-10 box-shadow-2 p-0">
              ...
              <h4 style="font-weight: bold"> UAMS Recover Password</h4>
                  </div>
