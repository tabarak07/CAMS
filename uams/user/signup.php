...
<head>
  ...
  <title>University Addmission Management System|| User Signup
  </title>
        ...
        <ul class="nav navbar-nav flex-row">
          ...
          <li class="nav-item">
            <a class="navbar-brand" href="../index.php">
              ...
              <h3 class="brand-text">University Admission Management System  | User Signup</h3>
            </a>
          </li>
              ...
              <div class="card border-grey border-lighten-3 m-0">
                <div class="card-header border-0 pb-0">
                  <div class="card-title text-center">
                   <h4 style="font-weight: bold"> UAMS User Signup</h4>
                  </div>
